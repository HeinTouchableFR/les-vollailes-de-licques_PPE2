...
<div class="container">
    ...
    <div class="row">
       ...
       echo '<form class="row" action="contactsend.php">
                ...
                <div class="col-7">
                    <input class="form-control mr-sm-2" type="text" size="20" name="Nom">
                 </div>
                ...
                <div class="col-7">
                    <input class="form-control mr-sm-2" type="text" size="20" name="Prenom">
                 </div>
                ...
                <div class="col-7">
                    <input class="form-control mr-sm-2" type="text" size="20" name="Mail">
                 </div>
                ...
                <div class="col-7">
                    <input class="form-control mr-sm-2" type="text" size="20" name="Objet">
                 </div>
                ...
                <div class="col-7">
                    <textarea name="Message" size="200"></textarea>
                 </div>
